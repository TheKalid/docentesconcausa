...
$archivo_json = __DIR__ . '/preguntas_vertical_docentes.json';

/************************************************************
 * CARGA OPTIMIZADA Y CACHÉ
 ************************************************************/
function cargarBancoPreguntas($archivo_json) {
    // [CRÍTICO] Llave de caché única para SIMULADOR BÁSICO / VERTICAL
    $cache_key = 'banco_vertical_basico';

    // 1. Intentar obtener desde APCu (Memoria Caché del Servidor)
    ...
    if (!file_exists($archivo_json)) {
        return ['status' => 'error', 'msg' => "No se encontró el archivo 'preguntas_vertical_docentes.json'."];
    }
    ...
    // 3. Guardar en caché por 1 hora si APCu está disponible
...
<head>
    ...
    <title>Simulador Vertical | Vanguardia Magisterial</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col">
    ...
    <nav class="bg-white shadow-md border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8 fixed w-full top-0 z-50">
        <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-vm-dark hidden sm:block">Simulador <span class="text-vm-light">Directivo</span></span>
        </div>
    ...
    <script>
        ...
        function iniciar() {
            ...
            // [RENDIMIENTO] Mezcla en el cliente
        ...
        function mostrarPregunta(index) {
            ...
            const textoPreguntaReal = p.pregunta || p.question || "Error: Pregunta sin texto";
            ...
            // Estandarizamos el acceso a opciones
