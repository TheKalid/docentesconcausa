...
// Obtener los usos restantes del usuario desde la BD
$usos_restantes = 0; 
...
// [RENDIMIENTO] Cerramos la conexión y liberamos la sesión en el servidor
// (Esto NO cierra la página del usuario, solo libera RAM en tu VPS)
$conexion->close();
session_write_close(); 
// ===== FIN DEL BLOQUE =====
?>
...
<head>
    ...
    <style>
        ...
        .counter-section p { margin: 0; font-size: 1.2rem; font-weight: 600; color: var(--color-primario); }
        .counter-section p i { margin-right: 8px; color: var(--color-acento); }
        .counter-section p span { font-weight: 700; font-size: 1.5rem; }
        ...
        #btn-descargar-pdf { background-color: #dc2626 !important; color: white !important; margin-top: 20px; width: 100%; display: flex; justify-content: center; align-items: center; gap: 8px; }
        #btn-descargar-pdf:hover { background-color: #b91c1c !important; }
...
<body>
    ...
    <script>
        // [SEGURIDAD] Inyectamos el Token CSRF en JS
            ...
            try {
                const response = await fetch('procesar_bitacora_de_profesor.php', {
                    ...
                    headers: { 
                        ...
                        'X-CSRF-Token': csrfToken // Enviamos firma digital
                    },
        ...
        document.getElementById('btn-descargar-pdf').addEventListener('click', () => {
            const elemento = document.getElementById('bitacora-preview');
            const btnPDF = document.getElementById('btn-descargar-pdf');
            
            const opciones = {
                margin:       [15, 15, 15, 15], 
                filename:     'Bitacora_Docente.pdf',
