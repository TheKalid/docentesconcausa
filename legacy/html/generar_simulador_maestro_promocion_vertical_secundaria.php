...
$archivo_json = __DIR__ . '/preguntas_promocion_vertical_secundaria.json';

/************************************************************
 * CARGA OPTIMIZADA Y CACHÉ CORREGIDO
 ************************************************************/
function cargarBancoPreguntas($archivo_json) {
    // [CRÍTICO] Llave de caché única para VERTICAL SECUNDARIA
    $cache_key = 'banco_vertical_secundaria';
...
<head>
    ...
    <title>Simulador Vertical Secundaria | Vanguardia Magisterial</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col">
    ...
    <nav class="bg-white shadow-md border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8 fixed w-full top-0 z-50">
        <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-vm-dark hidden sm:block">Simulador <span class="text-vm-light">Directivo Secundaria</span></span>
        </div>
