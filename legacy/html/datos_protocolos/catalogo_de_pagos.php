...
// Guardamos el ID del usuario para usarlo en el JavaScript.
...
<head>
    ...
    <style>
        ...
        .cta-button:disabled { background-color: #bdc3c7; cursor: not-allowed; pointer-events: none; }
        .cta-button:disabled:hover { background-color: #bdc3c7; }
...
<body>
    ...
    <div class="main-container">
        ...
        <main class="pricing-container">
            <article class="pricing-card">
                ...
                <div class="card-price"><span class="currency">$</span><span class="amount">115</span><span class="period">/mes</span></div>
                ...
                <button class="cta-button" id="plan-basico">Elegir este plan</button>
            </article>
            ...
            <article class="pricing-card recommended">
                ...
                <div class="card-price"><span class="currency">$</span><span class="amount">169</span><span class="period">/mes</span></div>
                <ul class="card-benefits">
                ...
                <button class="cta-button" id="plan-mentor">Elegir este plan</button>
            </article>

            <article class="pricing-card disabled-card">
                <div class="card-icon">👨‍🏫</div>
                <h3 class="card-title">Líder con Causa</h3>
                ...
                <button class="cta-button" id="plan-lider" disabled>Próximamente</button>
            </article>
        </main>
   ...
   <script>
        ...
        const stripe = Stripe('pk_live_51PmpIaI8fBGkCwpDOzPdY1whM3Tcrca3TnRFnK4d4J2k8ZvGpsHc7sC2ySddGteTNM9XkEmfetez7VcbI744mx5600vm5AI5Wt'); 
        
        // Asignamos los eventos a los botones
        document.getElementById('plan-basico').addEventListener('click', function() { iniciarPago('basico'); });
        document.getElementById('plan-mentor').addEventListener('click', function() { iniciarPago('mentor'); });
        
        // Función que se comunica con el backend para iniciar el pago
        async function iniciarPago(planId) {
            try {
                // ✅ CORRECCIÓN CLAVE: Cambiamos el guion por un guion bajo para que coincida con tu nombre de archivo.
                const response = await fetch('crear_sesion_pago.php', {
                    method: 'POST',
                ...
                if (session.error) {
                    alert(session.error);
                    if (session.error.includes("iniciar sesión")) {
